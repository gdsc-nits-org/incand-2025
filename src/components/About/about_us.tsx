      ...
      <div className="absolute inset-0 flex items-center bg-[#FFA6F6] bg-[url('/assets/images/maze.png')] bg-cover bg-no-repeat">
        ...
        >
          ...
          <div className="relative top-[17%] flex justify-center align-middle md:top-[14%] lg:top-[17%] xl:top-[12%]">
            <p
              className={`w-[100%] text-center font-tusker text-[25px] leading-[2.4rem] tracking-normal sm:text-[34px] sm:leading-[3.2rem] md:text-[34px] md:leading-[3.3rem] lg:text-[34px] lg:leading-[3.2rem] xl:text-[30px] xl:leading-[3rem] xl:tracking-wide ${styles.smallFont}`}
            >
