...
const HiddenQuest = () => {
  ...
  return (
    <div className="scrollbar-hide relative mx-auto mt-40 box-border h-[50vh] w-full overflow-y-auto shadow-gray-600">
      {!isVisible && (
      ...
      {isVisible && (
        <div className="fixed left-28 top-36 z-[4] h-8 w-8 bg-yellow-500"></div>
      )}
      {isVisible && (
        <div className="fixed right-28 top-36 z-[2] h-8 w-8 bg-yellow-500"></div>
      )}

      {isVisible && (
        <div className="fixed bottom-48 left-28 z-[2] h-8 w-8 bg-yellow-500"></div>
      )}

      {isVisible && (
        <div className="fixed bottom-48 right-28 z-[2] h-8 w-8 bg-yellow-500"></div>
      )}
