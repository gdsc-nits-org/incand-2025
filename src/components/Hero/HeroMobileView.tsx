  ...
  return (
    ...
    >
      ...
      >
        ...
        <p
          className="relative top-[36vw] text-[3vw] md:top-[-0vw] md:text-[1.2vw]"
        ...
        <div className="relative left-[2.945vw] top-[-3.658vw] h-[90.065vw] md:h-[31.026vw]">
          ...
          <div
            className={
              "absolute right-[20.171vw] top-[43.237vw] z-[32] h-[18.333vw] w-[14.444vw] rounded-[2.053vw] border border-black bg-[#00E9F4] shadow-black md:right-[37.171vw] md:top-[-7.237vw] md:z-[32] md:h-[13.092vw] md:w-[8.0vw] md:rounded-[1.053vw] " +
              styles.cardOne
            }
          >
          ...
          <div
            className={
              "absolute right-[10.724vw] top-[8.974vw] z-[31] h-[37.778vw] w-[37.778vw] overflow-x-hidden rounded-[2.053vw] border border-black bg-[#008EFF] shadow-black md:right-[20.724vw] md:top-[1.974vw] md:z-[31] md:h-[18.75vw] md:w-[18.75vw] md:rounded-[1.053vw] " +
              styles.cardOne
            }
          >
            <div className="flex h-[3.75vw] w-full flex-row items-center gap-[0.755vw] rounded-t-[2.053vw] border-b-[0.132vw] border-t-[0px] border-black bg-white px-[1.526vw] md:h-[2.368vw] md:gap-[0.526vw] md:rounded-t-[1.053vw] md:border-t-[0.132vw] md:px-[0.526vw]">
            ...
            <div className="flex h-[80%] flex-col justify-end">
              <div className="relative flex w-full flex-col justify-center">
                <div
                  className={
                    "flex w-fit flex-col items-center justify-center gap-[1.833vw] px-[2vw] md:gap-[0.833vw] md:px-[1vw] " +
          ...
          <div
            className={
              "group absolute left-[9.921vw] top-[3.566vw] z-30 w-[28.056vw] overflow-hidden rounded-[2.053vw] border border-black bg-[#00FF88] shadow-[0.526vw_0.526vw_0px_#000000] shadow-black transition duration-300 hover:bg-black md:left-[-5.921vw] md:top-[1.566vw] md:w-[14.474vw] md:rounded-[1.053vw]"
            }
          >
        ...
        >
          ...
          <svg
            className="absolute left-[-50vw] top-[-5vw] z-[1000] w-[6.5vw] md:left-[-46vw] md:top-[4.8vw] md:w-[3vw]"
            viewBox="0 0 69 69"
            fill="none"
            xmlns="http://www.w3.org/2000/svg"
          >
        ...
        <div className="items-centre absolute top-[65vw] z-[1000] flex flex-col justify-center gap-[0.5vw] md:top-[8vw] md:flex-row">
          <div className="relative left-[-8vw] flex gap-[1vw] md:left-0 md:gap-[0.5vw]">
            ...
            <p
              className={
                "h-[24vw] w-[6vw] text-[22vw] text-[#B572F9] md:h-[13vw] md:w-[3vw] md:text-[11vw] " +
                styles.comingSoonBorders
              }
            >
              I
            ...
            <p
              className={
                "relative left-[1vw] top-[3vw] h-[26vw] w-[14vw] text-[23vw] text-[#B572F9] md:top-[2vw] md:h-[14vw] md:w-[7vw] md:text-[11vw] " +
                styles.comingSoonBorders
              }
            >
              N
            ...
            <p
              className={
                "relative left-[1vw] top-[12vw] h-[20vw] w-[12vw] text-[16vw] text-[#B572F9] md:top-[6vw] md:h-[11vw] md:w-[7vw] md:text-[9vw] " +
                styles.comingSoonBorders
              }
            >
              C
            ...
            <p
              className={
                "relative left-[0.5vw] top-[-2.5vw] h-[30vw] w-[18vw] text-[24vw] text-[#B572F9] md:h-[16vw] md:w-[10vw] md:text-[13vw] " +
                styles.comingSoonBorders
              }
            >
              A
            ...
            <p
              className={
                "relative top-[3vw] h-[22vw] w-[10vw] text-[18vw] text-[#B572F9] md:top-[-1vw] md:h-[12vw] md:w-[6vw] md:text-[9vw] " +
                styles.comingSoonBorders
              }
            >
              N
            ...
            <p
              className={
                "relative top-[2vw] h-[26vw] w-[14vw] text-[21vw] text-[#B572F9] md:h-[14vw] md:w-[6.5vw] md:text-[11vw] " +
                styles.comingSoonBorders
              }
            >
              D
          ...
          <div className="relative left-[7vw] top-[-2vw] flex gap-[3vw] md:left-0 md:top-0 md:gap-[0.5vw]">
            <p
              className={
                "relative top-[5vw] h-[13vw] w-[7vw] text-[16vw] text-[#B572F9] md:top-[-1vw] md:w-[6vw] md:text-[10vw] " +
                styles.comingSoonBorders
              }
            >
              E
            ...
            <p
              className={
                "relative top-[2vw] h-[16vw] w-[10vw] text-[24vw] text-[#B572F9] md:w-[8vw] md:text-[13vw] " +
                styles.comingSoonBorders
              }
            >
              S
            ...
            <p
              className={
                "relative top-[5vw] h-[11vw] w-[7vw] text-[15vw] text-[#B572F9] md:top-[2vw] md:w-[6vw] md:text-[9vw] " +
                styles.comingSoonBorders
              }
            >
              C
            ...
            <p
              className={
                "relative top-[6vw] h-[11vw] w-[7vw] text-[16vw] text-[#B572F9] md:top-0 md:w-[6vw] md:text-[9vw] " +
                styles.comingSoonBorders
              }
            >
              E
            ...
            <p
              className={
                "h-[16vw] w-[10vw] text-[22vw] text-[#B572F9] md:w-[7vw] md:text-[13vw] " +
                styles.comingSoonBorders
              }
            >
              N
            ...
            <p
              className={
                "relative top-[8vw] h-[11vw] w-[8vw] text-[15vw] text-[#B572F9] md:w-[5.5vw] md:text-[9vw] " +
                styles.comingSoonBorders
              }
            >
              C
            ...
            <p
              className={
                "h-[16vw] w-[8vw] text-[23vw] text-[#B572F9] md:text-[13vw] " +
                styles.comingSoonBorders
              }
            >
              E
      ...
      <div
        className="absolute bottom-[2vw] left-[4vw] flex md:bottom-[1vw] md:left-[2vw]"
        style={{ transform: `scale(${scale})`, transformOrigin: "0 100%" }}
      >
        <p
          className="text-[6vw] md:text-[2vw]"
          style={{ fontFamily: "Tusker Grotesk" }}
        >
          Scroll Down
        </p>
        <div className="relative left-[2vw] w-[3vw] md:left-[1vw] md:w-[1.5vw]">
          <Image
