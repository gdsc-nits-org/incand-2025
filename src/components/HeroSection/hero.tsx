    ...
    >
      <div className="absolute inset-0 flex flex-col items-center justify-center bg-[url('/assets/landing/maze.png')] bg-cover bg-center bg-no-repeat">
        ...
        <div className="relative left-[2.945vw] top-[0.658vw] h-[90.065vw] md:h-[23.026vw]">
          ...
          <div
            className={
              "absolute right-[20.171vw] top-[43.237vw] z-[3] h-[18.333vw] w-[14.444vw] rounded-[2.053vw] border border-black bg-[#E1067B] shadow-black md:right-[37.171vw] md:top-[-7.237vw] md:h-[13.092vw] md:w-[8.0vw] md:rounded-[1.053vw] " +
              styles.cardOne
            }
          >
          ...
          >
            ...
            <p
              className={
                "absolute bottom-[-2.947vw] right-[-0.87vw] w-[11.576vw] text-[13.197vw] font-normal tracking-wide text-white md:w-[8.061vw] md:text-[8.197vw] " +
                styles.nText
              }
          ...
          >
            ...
            <div className="absolute left-[-3.005vw] top-[-1.974vw] flex gap-[2.937vw] overflow-visible md:gap-[2.045vw]">
              ...
              <p
                className={
                  "relative top-[10.316vw] h-[23.618vw] w-fit text-[13.197vw] font-normal leading-[8.197vw] tracking-wide text-white hover:text-[7.197vw] md:top-[-1.316vw] md:h-[16.447vw] md:text-[8.197vw] " +
                  styles.gText
                }
              >
                I
          ...
          >
            ...
            <div className="flex h-full flex-col justify-end">
              <div className="absolute top-[9vw] flex w-full overflow-visible md:top-0">
                <p
                  className={
                    "relative left-[0.587vw] top-[1.316vw] w-[10.858vw] text-[13.197vw] font-normal leading-[none] tracking-wide text-white hover:text-[7.197vw] group-hover:text-[#00FF88] md:w-[7.561vw] md:text-[9.197vw] " +
                    styles.nText
                  }
                >
                  N
                ...
                <p
                  className={
                    "relative left-[1vw] top-[3.947vw] h-[23.618vw] w-[11.576vw] text-[13.197vw] font-normal leading-[none] tracking-wide text-white hover:text-[7.197vw] group-hover:text-[#00FF88] md:h-[16.447vw] md:w-[8.061vw] md:text-[8.197vw] " +
                    styles.gText
                  }
                >
                  G
          ...
          <div
            className={
              "absolute left-[-45.316vw] top-[58.158vw] z-[2] h-[23.611vw] w-[43.889vw] overflow-hidden rounded-[2.053vw] border border-black bg-[#B5FCFF] shadow-black md:left-[-1.316vw] md:top-[13.158vw] md:z-[0] md:h-[11.842vw] md:w-[22.039vw] md:rounded-[1.053vw] " +
              styles.cardOne
            }
          >
            <div className="flex h-[3.75vw] w-full flex-row items-center gap-[0.755vw] rounded-t-[2.053vw] border-b-[0.132vw] border-t-[0px] border-black bg-white px-[1.526vw] md:h-[2.368vw] md:gap-[0.526vw] md:rounded-t-[1.053vw] md:border-t-[0.132vw] md:px-[0.526vw]">
          ...
          >
            ...
            <div className="relative h-[85%] w-full">
              ...
              >
                ...
                <circle
                  ...
                  cy="2.26925"
                  r="2.26925"
                  transform="matrix(-0.275637 -0.961262 -0.961262 0.275637 94.8535 62.1626)"
                  fill="#E1067B"
                />
                <path
                ...
                <circle
                  ...
                  cy="1.29532"
                  r="1.29532"
                  transform="matrix(-0.325568 -0.945518 -0.945518 0.325568 86.1475 83.7266)"
                  fill="#E1067B"
                />
                <path
                ...
                <ellipse
                  ...
                  rx="3.27719"
                  ry="3.27719"
                  transform="matrix(0.275637 0.961262 0.961262 -0.275637 -0.373047 60.0825)"
                  fill="#E1067B"
                />
              </svg>
            ...
            <div className="absolute left-[5.645vw] top-0 flex h-[85%] w-full overflow-hidden md:left-[1.645vw]">
              <p
                className={
                  "relative top-[-8.961vw] w-[10.858vw] text-[18.197vw] font-normal leading-[none] tracking-wide text-white hover:text-[8.197vw] md:top-[-2.961vw] md:w-[7.561vw] md:text-[10.197vw] " +
          ...
          <p
            className={
              "absolute left-[28.508vw] top-[33.579vw] w-[10.858vw] text-[18.197vw] font-normal leading-[none] tracking-wide text-white hover:text-[8.197vw] md:left-[31.508vw] md:top-[-6.579vw] md:w-[7.561vw] md:text-[10.197vw] " +
              styles.comingSoonBorders
            }
          >
            N
          ...
          <p
            className={
              "absolute right-[20.724vw] top-[-1.974vw] z-30 w-[10.858vw] text-[16.197vw] font-normal leading-[none] tracking-wide text-white hover:text-[12.197vw] md:w-[7.561vw] md:text-[10.197vw] md:hover:text-[8.197vw] " +
              styles.comingSoonBorders
            }
          >
            O
          ...
          {/* Svg2 */}
          <svg
            className="absolute left-[19vw] top-[-22vw] z-[1000] w-[4.188vw] md:left-[2vw] md:top-[-11vw] md:w-[2.188vw]"
            width="37"
            height="33"
            viewBox="0 0 37 33"
            fill="none"
          ...
          {/* Svg4 */}
          <svg
            className="absolute left-[21vw] top-[31vw] z-[1000] w-[3.5vw] md:left-[24vw] md:top-[-6vw] md:w-[1.5vw]"
            viewBox="0 0 32 32"
            fill="none"
            xmlns="http://www.w3.org/2000/svg"
          >
          ...
          {/* Svg5 */}
          <svg
            className="absolute z-[1000] hidden md:left-[29vw] md:top-[-9vw] md:block md:w-[3.5vw]"
            viewBox="0 0 61 58"
            fill="none"
            xmlns="http://www.w3.org/2000/svg"
          >
          ...
          {/* Svg6 */}
          <svg
            className="absolute left-[34vw] top-[20vw] z-[1000] w-[7.5vw] md:left-[35vw] md:top-[-12vw] md:w-[2.5vw]"
            viewBox="0 0 50 50"
            fill="none"
            xmlns="http://www.w3.org/2000/svg"
          >
          ...
          {/* Svg7 */}
          <svg
            className="absolute hidden md:left-[35vw] md:top-[-7vw] md:block md:w-[2.5vw]"
            viewBox="0 0 36 36"
            fill="none"
            xmlns="http://www.w3.org/2000/svg"
          >
          ...
          >
            ...
            <ellipse
              ...
              rx="3.27719"
              ry="3.27719"
              transform="matrix(-0.559193 0.829038 0.829038 0.559193 7.12988 -1.16895)"
              fill="#E1067B"
            />
          </svg>
          {/* Svg8*/}
          ...
          {/* Svg15*/}
          <svg
            className="absolute left-[-50vw] top-[-5vw] z-[1000] w-[6.5vw] md:left-[-39vw] md:top-[-9.8vw] md:w-[2.5vw]"
            viewBox="0 0 69 69"
            fill="none"
            xmlns="http://www.w3.org/2000/svg"
          >
            ...
            <defs>
              ...
              >
                ...
                <feBlend
                  mode="normal"
                  in2="BackgroundImageFix"
                  result="effect1_dropShadow_411_5125"
                />
                <feBlend
                  mode="normal"
                  in="SourceGraphic"
                  in2="effect1_dropShadow_411_5125"
                  result="shape"
                />
              </filter>
            </defs>
          ...
          {/* Svg16*/}
          <svg
            className="absolute left-[-49vw] top-[6vw] z-[1000] w-[1.5vw] md:left-[-44vw] md:top-[-9vw] md:w-[1vw]"
            viewBox="0 0 20 20"
            fill="none"
            xmlns="http://www.w3.org/2000/svg"
          >
          ...
          {/* Svg17*/}
          <svg
            className="absolute left-[-48vw] top-[-22vw] z-[1000] w-[4.5vw] md:left-[-48vw] md:top-[-12vw] md:w-[3vw]"
            viewBox="0 0 50 46"
            fill="none"
            xmlns="http://www.w3.org/2000/svg"
          >
