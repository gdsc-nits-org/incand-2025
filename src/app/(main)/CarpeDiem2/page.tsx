        ...
        {isLap && (
          <>
            <div className={styles.carped + ""}>
              ...
              <div className="absolute left-[93.2%] top-[14%] h-[58vh] w-[4.2vw]">
                <Image
                  src="/assets/CarpeDiem/revealingsoon2.png" // Path to your GIF
                  alt="Name"
                  fill={true}
                  className={" "}
                  style={{ zIndex: "2" }}
              ...
              <div className="absolute left-[72%] top-[24%] h-[50vh] w-[20vw]">
                <Image
                  src="/assets/CarpeDiem/artist2.png" // Path to your GIF
                  alt="Singer"
                  fill={true}
                  className={" "}
                  style={{ zIndex: "2" }}
