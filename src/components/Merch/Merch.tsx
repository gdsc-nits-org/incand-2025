...
const StyledSection: React.FC = () => {
  return (
    ...
    >
      ...
      ></div>
      <div className="absolute -top-[2.9vw] ipadair:scale-50 left-[8.5vw] mobile:hidden laptop:block">
        <Image
      ...
      <div className="relative z-30 w-[80vw] border-4 border-white bg-[#2D0079] shadow-[-1.5vw_1.5vw_0px_rgba(255,255,255,1)] mobile:h-[70vh] mobile:-translate-y-[20vw] ipadpro:-translate-y-[2vw] ipadpro:scale-x-75 xl:h-[60vh] laptop:transform-none">
        ...
        <div className="4k: absolute z-50 mobile:left-[8.5vw] mobile:top-[70vh] mobile:scale-[1.4] laptop:-left-[8vw] laptop:top-[20vw] laptop:scale-[.90] ipadpro:scale-75">
          <FooterButton />
        </div>
        ...
        <CgArrowTopLeft className="absolute z-[45] -rotate-[18deg] text-[#FAE00D] mobile:left-[62vw] mobile:top-[82vh] mobile:text-[6vh] laptop:left-[25vw] ipadpro:left-[43vw] laptop:top-[25vw] laptop:text-[3.2vw]" />
