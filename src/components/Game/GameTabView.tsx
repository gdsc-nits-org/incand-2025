...
const GameTabView: React.FC<GameTabViewProps> = ({
  level,
  lettersHaving,
  top10Players,
  setUploadPopup,
    ...
    <div>
      ...
      <section ref={heroRef}>
        <div className={`relative grid h-screen bg-black md:h-[46vw]`}>
          <div
            className={`absolute left-[-2.1vw] h-full w-screen bg-[url('/assets/Game/game_anim.gif')] bg-cover bg-center bg-no-repeat md:left-[-1.1vw]`}
          >
            {" "}
          </div>
          <div
          ...
          <div
            className={`relative z-[1] mt-[10vh] h-[9vh] w-[35.5vw] justify-self-center md:mt-[3vw] md:h-[12vh] md:w-[10.5vw]`}
          >
            <Image
          ...
          <div
            className={`relative bottom-[2vw] flex flex-col items-center justify-center self-end justify-self-center md:mt-[-10vw]`}
          >
            <p
              className={
            ...
            <button
              ...
              className={`relative z-[1] mt-[-5vh] h-[20vh] w-[30vw] md:mt-[-2vw] md:h-[10vw] md:w-[10vw]`}
            >
              <Image
                className={`object-contain`}
      ...
      <section ref={rulesRef}>
        ...
        >
          ...
          <div
            className={`relative right-[1vw] top-0 block w-full md:top-[8vw] md:hidden md:w-[95%]`}
          >
            <Image
              alt="rulePath"
          ...
          {/* Step 01 */}
          <div
            className={`absolute left-[10vw] top-[40vw] flex flex-col gap-[3vw] md:top-0 md:gap-[1vw]`}
          >
          ...
          {/* Step 02 */}
          <div
            className={`absolute top-[88vw] flex flex-col gap-[3vw] md:top-0 md:items-center md:gap-[1vw]`}
          >
            <div className={`flex w-fit flex-col items-center justify-center`}>
              <svg
          ...
          {/* Step 03 */}
          <div
            className={`absolute right-[10vw] top-[139vw] flex flex-col gap-[3vw] md:top-0 md:items-end md:gap-[1vw]`}
          >
            <div className={`flex w-fit flex-col items-center justify-center`}>
              <svg
                className={`hidden h-[19vw] md:block`}
      ...
      >
        ...
        >
          <div
            className={`flex items-center justify-center gap-[6vw] md:gap-[4vw]`}
          >
            <svg
              className={`w-[10vw]`}
              viewBox="0 0 166 328"
      ...
      >
        ...
        <div
          className={`absolute bottom-[3.25vw] right-[14vw] w-[18.1vw] md:bottom-[2.25vw] md:right-[10vw] md:w-[17.1vw]`}
        >
          <Image
        ...
        {/* Third Position */}
        <div
          className={`absolute left-[5vw] top-[33.5vw] hidden flex-col items-center justify-center md:flex`}
        >
        ...
        {/* Second Position */}
        <div
          className={`absolute left-[11vw] top-[57.25vw] flex flex-col items-center justify-center md:left-[25vw] md:top-[24.5vw]`}
        >
          ...
          <div
            className={`flex items-center justify-center gap-[8vw] md:gap-[4vw]`}
          >
            <svg
        ...
        {/* First Position */}
        <div
          className={`absolute right-[13vw] top-[33.8vw] flex flex-col items-center justify-center md:right-[10vw] md:top-[11vw]`}
        >
          <div
            className={`relative bottom-[-0.9vw] left-[-1vw] h-[31vw] w-[31vw] -rotate-[11deg] md:h-[15.5vw] md:w-[15.5vw]`}
          >
            <Image
              className={`rounded-[0.5vw] object-cover`}
          ...
          {top10Players
            ...
            .map((player, index) => (
              ...
              >
                ...
                <div
                  className={`flex items-center justify-center gap-[1vw] border-r-[0.5vw] border-black px-[1vw] py-[0.2vw] md:gap-[0.5vw] md:border-r-[0.3vw]`}
                >
                  <svg
