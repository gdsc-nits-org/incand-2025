...
const HiddenQuest = () => {
  ...
  return (
    ...
    <>
    {!isVisible && (
    <div className="fixed left-1/2 top-1/2  h-[24px] w-[24px] rounded-md" onClick={handleOpen}>
      <img
   ...
   {isVisible && ( <div className="fixed   left-36 top-48 box-border h-[50vh] w-[80vw] bg-green-600  shadow-gray-600">
        ...
        <div className="absolute -left-2 -bottom-1 z-[2] h-4 w-4 bg-yellow-500"></div>
    

     
        <div className="absolute -right-2 -bottom-1 z-[2] h-4 w-4 bg-yellow-500"></div>
        ...
        <div className="relative overflow-y-auto scrollbar-hide box-border h-[50vh] w-full bg-black">
          <div id="firstDiv" className="relative box-border h-[50vh] w-[98%] overflow-hidden bg-gray-100 bg-[url('/assets/HiddenQuest&Button/bgImage.gif')] bg-[length:100%_100%] border-8 border-black">
