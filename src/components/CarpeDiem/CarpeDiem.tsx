...
const CarpeDiem = () => {
  ...
  return (
  <>
  {isLap && <>   <div className={styles.carped}>
      <Image
    ...
    {isPhone && <> 
    <div className="bg-[#EE79BD] h-screen">
    <div className="absolute left-[17%] top-[12%] h-[12px] w-[65vw]">
      ...
      <div className="absolute left-[9%] top-[15%] h-[25vh] w-[83vw]" style={{ border: "2px solid black", 
    borderRadius: "24px", 
    overflow: "hidden",}}>
        <Image
      ...
      <div className="absolute left-[84%] top-[74%] h-[21.7vh] w-[8vw]">
        <Image
          ...
          fill={true}
          className={" "}
          style={{ zIndex: "2",   borderTopLeftRadius: "0px", 
            borderTopRightRadius: "0px",
            borderBottomLeftRadius: "0px",
     ...
     {isIpad && <><div className={styles['carped-ipad']}>
      <Image
        src="/assets/CarpeDiem/background.png"
        fill={true}
        alt="background"
      ...
      />
      {/* Overlayed GIF */}
      <div className={"absolute left-8 top-[6.5%] h-[80vh] w-[25vw] rounded-lg"}>
        <Image
          src="/assets/CarpeDiem/disc.gif" // Path to your GIF
          alt="overlay gif"
          fill={true}
