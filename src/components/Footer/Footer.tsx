...
const Footer: React.FC = () => {
  ...
  return (
    <footer className="hide relative flex-col items-center justify-start gap-[1rem] overflow-hidden bg-black pt-[2rem] text-white">
      ...
      <div className="xl:-translate-0 flex flex-col items-center justify-center ipadpro:-translate-y-16">
        ...
        <div
          className={
            "xl:-translate-0 mb-[1rem] mt-[4rem] flex flex-col items-center justify-center gap-0 ipadpro:-translate-y-16 ipadpro:scale-x-110 lg:flex-row xl:scale-x-100"
          }
        >
          <Link
