        ...
        <div className="relative left-[2.945vw] top-[0.658vw] h-[90.065vw] md:h-[23.026vw]">
          ...
          >
            ...
            <div className="relative h-[85%] w-full">
              ...
              <p
                className="absolute bottom-[11.625vw] left-[10.316vw] text-[6.389vw] font-normal tracking-wide text-black md:bottom-0 md:left-[-1.316vw] md:text-[4.211vw] z-10"
                style={{ fontFamily: "Ahsing" }}
              >
                Cultural Fest
              </p>
          ...
          {/* Svg1 */}
          <svg className="absolute md:w-[3.188vw] md:top-[-12vw] md:left-[-9vw] w-[8.188vw] top-[-29vw] left-[4vw] z-[1000]"
            viewBox="0 0 57 57"
            fill="none"
            xmlns="http://www.w3.org/2000/svg"
          >
