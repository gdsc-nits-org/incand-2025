        ...
        >
          ...
          <div className="relative top-[15%] flex justify-center xl:top-[12%]">
            <Image
              ...
              alt="About Us Image"
              className="h-[100%] w-[100%] rotate-[4.21deg] sm:h-[50%] sm:w-[80%] sm:rotate-[4.21deg] md:h-[60%] md:w-[85%] lg:h-[80%] lg:w-[80%] lg:rotate-[4.21deg] xl:h-[90%] xl:w-[80%]"
              width={1200}
              height={1600}
            />
          </div>
