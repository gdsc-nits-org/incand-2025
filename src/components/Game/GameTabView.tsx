...
interface GameTabViewProps {
    ...
    top10Players: { name: string; pic: string; letters: string; level: number; flag: Date; }[];
    setUploadPopup: (value: boolean) => void;
  }


 const GameTabView: React.FC<GameTabViewProps> = ({ level, lettersHaving, top10Players, setUploadPopup }) => {
    ...
    return (
        ...
        <div className={`relative grid h-screen bg-black md:h-[46vw]`}>
          <div
            className={
              `absolute left-[-2.1vw] h-full w-screen bg-[url('/assets/Game/game_anim.gif')] bg-cover bg-center bg-no-repeat md:left-[-1.1vw]`
            }
          >
            {" "}
          </div>
          <div className={`absolute h-full w-screen bg-[url('/assets/landing/maze.png')] bg-cover bg-center bg-no-repeat md:inset-0 md:bg-contain`}></div>
  
          <div className={`relative z-[1] mt-[10vh] h-[9vh] w-[35.5vw] justify-self-center md:mt-[3vw] md:h-[12vh] md:w-[10.5vw]`}>
            <Image
          ...
          <div className={`relative bottom-[2vw] flex flex-col items-center md:mt-[-10vw] justify-center self-end justify-self-center`}>
            <p
              className={
                `z-[1] text-center text-[6.5vh] font-medium leading-[6.5vh] tracking-wider text-[#FFA6F6] md:text-[6.25vw] md:leading-[6.25vw] ` +
                styles.heroText
              }
            ...
            <p
              className={`z-[1] mt-[5vh] px-[12vw] text-center text-[2vh] font-medium leading-[3vh] tracking-wider text-white md:mt-[2vw] md:text-[1.5vw] md:leading-[2.5vw]`}
            ...
            <button  onClick={scrollToRulesSection} className={`relative z-[1] mt-[-5vh] h-[20vh] w-[30vw] md:mt-[-2vw] md:h-[10vw] md:w-[10vw]`}>
              <Image
                className={`object-contain`}
        ...
        <div
          id="rulesContainer"
          className={
            `relative mt-[-5vw] flex h-[180vw] items-center justify-center rounded-t-[4vw] bg-[#FFC2F9] md:mt-[-2vw] md:h-[50vw] md:rounded-t-[2vw]`
          }
        >
...
<path d="M752 34.5V34.5C747.846 8.65222 779.45 -7.16654 797.652 11.65L803.666 17.8675C809.305 23.6966 812.293 31.5913 811.927 39.6931L811.386 51.6705C810.038 81.5069 785.998 105.304 756.149 106.346L704.869 108.138C697.971 108.379 691.065 107.987 684.238 106.966L634.256 99.4945C609.786 95.8365 585.078 94 560.335 94H434L291.5 86L244.861 82.8717C221.597 81.3114 198.285 85.1043 176.715 93.9591V93.9591C166.932 97.9755 157.592 102.998 148.848 108.947L92.5618 147.234C81.9236 154.471 74.4482 165.494 71.6613 178.055L57.0908 243.724C51.5864 268.533 17.9184 272.569 6.70663 249.764V249.764C-5.07672 225.796 21.5052 201.167 44.5059 214.741L58.5 223V223C73.1885 232.466 90.2931 237.5 107.768 237.5H291.5L374.015 244.908C421.974 249.214 462.807 281.566 477.968 327.27L496.941 384.471C509.725 423.011 553.361 441.664 590.054 424.276L597.631 420.685C624.785 407.817 657.272 417.67 672.703 443.453V443.453C680.582 456.619 693.329 466.152 708.184 469.989L730.811 475.834C740.232 478.268 749.924 479.5 759.655 479.5H841.165C902.697 479.5 958.989 444.862 986.724 389.935L991.889 379.704C1022.53 319.026 1090.48 286.932 1156.81 301.818V301.818C1197.1 310.861 1239.34 302.701 1273.36 279.301L1349 227.281C1352.66 224.768 1356.58 222.675 1360.7 221.041L1364.57 219.507C1376.69 214.701 1390.22 214.917 1402.18 220.107V220.107C1407.35 222.352 1412.88 223.688 1418.51 224.056L1608.19 236.466C1618.71 237.154 1629.16 238.707 1639.43 241.108L1653.44 244.386C1674.82 249.386 1697.1 249.074 1718.33 243.477V243.477C1733.33 239.522 1747.53 233.001 1760.31 224.202L1779.71 210.844C1789.2 204.306 1797.86 196.634 1805.5 188V188" stroke="#E01A1A" stroke-width="6"/>
          ...
          <div className={`relative right-[1vw] top-0 block w-full md:top-[8vw] md:hidden md:w-[95%]`}>
            <Image
              alt="rulePath"
          ...
          <p
            className={`absolute left-[14vw] top-[15.5vw] text-[9vw] tracking-wider text-black md:left-[16.2vw] md:top-[7.5vw] md:text-[3.5vw]`}
          ...
          {/* Step 01 */}
          <div className={`absolute left-[10vw] top-[40vw] flex flex-col gap-[3vw] md:top-0 md:gap-[1vw]`}>
            <div className={`flex w-fit flex-col items-center justify-center`}>
              <svg
                className={`hidden h-[19vw] md:block`}
                viewBox="0 0 19 347"
                fill="none"
              ...
              <p
                className={`relative top-[-0.5vw] rounded-[1.5vw] border-[0.50vw] border-black bg-[#FAE00D] px-[5vw] py-[0.5vw] text-[5vw] font-bold shadow-[0.9vw_0.9vw_0px_#000000] md:rounded-[0.5vw] md:border-[0.15vw] md:px-[1.5vw] md:text-[1.5vw] md:shadow-[0.3vw_0.3vw_0px_#000000]`}
          ...
          {/* Step 02 */}
          <div className={`absolute top-[88vw] flex flex-col gap-[3vw] md:top-0 md:items-center md:gap-[1vw]`}>
            <div className={`flex w-fit flex-col items-center justify-center`}>
              <svg
                className={`hidden h-[31.5vw] md:block`}
                viewBox="0 0 19 590"
                fill="none"
                xmlns="http://www.w3.org/2000/svg"
              >
          ...
          {/* Step 03 */}
          <div className={`absolute right-[10vw] top-[139vw] flex flex-col gap-[3vw] md:top-0 md:items-end md:gap-[1vw]`}>
            <div className={`flex w-fit flex-col items-center justify-center`}>
              <svg
                className={`hidden h-[19vw] md:block`}
                viewBox="0 0 19 347"
        ...
        <div
          className={
            `relative mt-[-5vw] flex h-[70vw] overflow-x-hidden rounded-t-[4vw] border-[1.5vw] border-black bg-[#001E30] md:mt-[-2vw] md:h-[50vw] md:rounded-t-[2vw] md:border-[0.75vw]`
          }
        >
          ...
          <p
            className={`absolute left-[5vw] top-[4vw] text-[6.1vw] tracking-widest text-black md:left-[2vw] md:top-[2vw] md:text-[3.1vw]`}
            style={{ fontFamily: "Rocket Thunder" }}
          >
            Your collections
          </p>
          <svg
            className={`absolute right-[1vw] top-[12vw] w-[5.75vw] md:right-[0.5vw] md:top-[6vw] md:w-[2.75vw]`}
            viewBox="0 0 75 93"
            fill="none"
            xmlns="http://www.w3.org/2000/svg"
          >
          ...
          <svg
            className={`absolute right-[2vw] top-[2vw] w-[16vw] md:right-[1vw] md:top-[1vw] md:w-[8vw]`}
            viewBox="0 0 149 185"
            fill="none"
            xmlns="http://www.w3.org/2000/svg"
          >
          ...
          {/* Letters INCAND */}
          <div className={`absolute left-[50%] top-[50%] mt-[4vw] flex translate-x-[-50%] translate-y-[-50%] flex-col items-center justify-center`}>
            <div className={`flex items-center justify-center gap-[6vw] md:gap-[4vw]`}>
              <svg
                className={`w-[10vw]`}
                viewBox="0 0 166 328"
                fill="none"
            ...
            <p
              className={`mt-[2vw] text-[5vw] tracking-wider text-[#D2BEFF] md:mt-[1vw] md:text-[2.5vw]`}
              style={{ fontFamily: "Rocket Thunder" }}
            >
        ...
        <div
          className={
            `relative mt-[-5vw] flex h-[110vw] items-center justify-center rounded-t-[4vw] border-[1.75vw] border-black bg-[#FAE00D] md:mt-[-2vw] md:h-[60vw] md:rounded-t-[2vw] md:border-[0.75vw]`
          }
        >
          <div className={`absolute inset-0 bg-[url('/assets/landing/maze.png')] bg-cover bg-center bg-no-repeat opacity-40`}></div>
          <p
          ...
          <div className={`absolute bottom-[3.25vw] right-[14vw] w-[18.1vw] md:bottom-[2.25vw] md:right-[10vw] md:w-[17.1vw]`}>
            <Image
          ...
          {/* Third Position */}
          <div className={`absolute top-[33.5vw] left-[5vw] hidden flex-col items-center justify-center md:flex`}>
            ...
            <div className={`relative right-[2vw] top-[-1vw] flex items-center justify-center`}>

              <p
                className={`w-[20vw] text-center text-[3vw] leading-[3vw] text-white`}
                style={{ fontFamily: "Rocket Thunder", whiteSpace: "normal", wordBreak: "break-word"}}
              >
                @ {top10Players[2]?.name.split(' ')[0]?.slice(0,maxCharsForUserID) ?? "Jayz"}
              </p>
            </div>
          </div>
          {/* Third Position */}
          ...
          {/* Second Position */}
          <div className={`absolute top-[57.25vw] left-[11vw] flex flex-col items-center justify-center md:top-[24.5vw] md:left-[25vw]`}>
            ...
            <div className={`flex items-center justify-center gap-[8vw] md:gap-[4vw]`}>
              <svg
                className={`w-[6vw] md:w-[3vw]`}
                viewBox="0 0 50 53"
                fill="none"
                xmlns="http://www.w3.org/2000/svg"
              >
            ...
            <div className={`relative flex items-center justify-center`}>
              <p
                className={`w-[30vw] text-[5vw] leading-[5vw] text-center text-white md:text-[3vw] md:leading-[3vw]`}
                style={{ fontFamily: "Rocket Thunder", whiteSpace: "normal", wordBreak: "break-word"}}
              >
                @ {top10Players[1]?.name.split(' ')[0]?.slice(0,maxCharsForUserID) ?? "Jayz"}
              </p>
            </div>
          </div>
          {/* Second Position */}
          ...
          {/* First Position */}
          <div className={`absolute top-[33.8vw] md:right-[10vw] right-[13vw] flex flex-col items-center justify-center md:top-[11vw]`}>
            <div className={`relative bottom-[-0.9vw] left-[-1vw] h-[31vw] w-[31vw] -rotate-[11deg] md:h-[15.5vw] md:w-[15.5vw]`}>
              <Image
                className={`rounded-[0.5vw] object-cover`}
            ...
            <div className={`relative top-[-1vw] flex items-center justify-center`}>
              <p
                className={`w-[30vw] text-center text-[5vw] leading-[5vw] text-white md:text-[3vw] md:leading-[3vw]`}
                style={{ fontFamily: "Rocket Thunder", whiteSpace: "normal", wordBreak: "break-word" }}
              >
                @ {top10Players[0]?.name.split(' ')[0]?.slice(0,maxCharsForUserID) ?? "Jayz"}
              </p>
            </div>
          </div>
          {/* First Position */}
        ...
        {top10Players.length > (leaderboardStartsFrom-1) && (
          <div
            className={
              `relative mt-[-5.1vw] flex flex-col items-center justify-center gap-[4vw] overflow-x-hidden rounded-t-[4vw] border-[1.75vw] border-black bg-gradient-to-b from-[#001E30] to-[#001E30] py-[12vw] md:mt-[-3.1vw] md:gap-[2vw] md:rounded-t-[2vw] md:border-[0.75vw] md:py-[6vw]`
            }
          >
            <div className={`absolute inset-0 bg-[url('/assets/Game/maze_white.png')] bg-cover bg-center bg-no-repeat`}></div>
            {top10Players.slice(leaderboardStartsFrom-1).map((player, index) => (
              <div
                ...
                className={`relative flex rounded-[1.8vw] border-[0.3vw] border-black bg-[#9C8FFE] shadow-[0.3vw_0.3vw_0px_#000000] md:rounded-[1vw]`}
              >
                <p
                ...
                <p
                  ...
                  style={{ fontFamily: "Rocket Thunder" }}
                >
                  {player.name.length>maxCharsForUserID?("@ "+ player.name.substring(0,maxCharsForUserID)+"..."):"@ "+(player.name)}
                </p>
                <div className={`flex items-center justify-center gap-[1vw] border-r-[0.5vw] border-black px-[1vw] py-[0.2vw] md:gap-[0.5vw] md:border-r-[0.3vw]`}>
                  <svg
                    className={`w-[2.5vw] md:w-[1.5vw]`}
                    viewBox="0 0 166 328"
                    fill="none"
                    xmlns="http://www.w3.org/2000/svg"
                ...
                <p
                  className={`hidden px-[3vw] py-[0.2vw] text-[2.5vw] md:block`}
                  style={{ fontFamily: "Rocket Thunder" }}
                >
        ...
        >
          ...
          <button
            onClick={(e) => {e.preventDefault();setUploadPopup(true);}}
          ...
          >
            <div className={`flex items-center justify-center gap-[4vw] md:gap-[2vw]`}>
              <svg
        ...
        <div
          className={
            `relative mt-[-5vw] flex items-center overflow-x-hidden rounded-t-[4vw] border-[1.75vw] border-black bg-[#001E30] py-[8vw] md:mt-[-2vw] md:rounded-t-[2vw] md:border-[0.75vw] md:py-0`
          }
        >
          ...
          <p
            className={
              `w-full text-center text-[8.333vw] leading-[8.333vw] text-white md:text-[3.333vw] ` +
          ...
          <button className={`me-[4vw] rounded-full bg-[#FAE00D] px-[0.5vw] py-[2.5vw] md:me-[10vw] md:py-[1.5vw]`}>
            <svg
