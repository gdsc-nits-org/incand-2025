...
const HeroTabView = () => {
  ...
  >
    ...
    >
      <div className="relative top-[6vw] right-[-35vw] ipadair:right-[-23vw] ipadair:z-20 z-[31] mt-[-7vw] flex flex-col items-center justify-center ipadair:mt-[0] ipadair:flex-row ipadair:items-start ipadair:gap-[0.789vw]">
        ...
        <div className="mt-[1.053vw] flex items-center justify-center gap-[0.755vw] ipadair:gap-[0.526vw]">
          <div className="group relative w-fit">
            {/* <svg
              className="absolute left-[-8.385vw] top-[1.042vw] z-[10] w-[26.667vw] ipadair:left-[-5.385vw] ipadair:top-[0.042vw] ipadair:w-[17.5vw]"
              viewBox="0 0 360 219"
              fill="none"
        ...
        <div
          className={
            "mx-[0.789vw] h-[29.444vw] w-[13.888vw] self-end rounded-[2.053vw] border border-black bg-[#E1067B] ipadair:h-[20.0vw] ipadair:w-[9.671vw] ipadair:rounded-[1.053vw] " +
            styles.cardOne
          }
        >
          <div className="flex h-[3.75vw] w-full flex-row items-center gap-[0.755vw] rounded-t-[2.053vw] border-b-[0.132vw] border-t-[0px] border-black bg-white px-[1.526vw] ipadair:h-[2.368vw] ipadair:gap-[0.526vw] ipadair:rounded-t-[1.053vw] ipadair:ipadair:border-t-[0.132vw] ipadair:px-[0.526vw]">
            <div className="h-[1.512vw] w-[1.512vw] rounded-full bg-black ipadair:h-[1.053vw] ipadair:w-[1.053vw]"></div>
            <div className="h-[1.512vw] w-[1.512vw] rounded-full bg-black ipadair:h-[1.053vw] ipadair:w-[1.053vw]"></div>
            <div className="h-[1.512vw] w-[1.512vw] rounded-full bg-black ipadair:h-[1.053vw] ipadair:w-[1.053vw]"></div>
          </div>
          <div className="relative top-[-5.66vw] flex h-full flex-col justify-center p-[0.789vw] ipadair:top-[-3.947vw]">
            <p
              className="mb-[-7vw] max-w-fit text-center text-[9vw] font-normal leading-none text-black transition-colors duration-200 hover:text-[#FAE00D] ipadair:mb-[-4.934vw] ipadair:text-[6.316vw]"
              style={{
                fontFamily: "Ahsing",
              }}
            >
            ...
            <p
              className="mb-[-7vw] max-w-fit self-end text-[9vw] font-normal text-black transition-colors duration-200 hover:text-[#FAE00D] ipadair:mb-[-4.934vw] ipadair:text-[6.316vw]"
              style={{ fontFamily: "Ahsing" }}
            >
              0
            </p>
            <p
              className="mb-[-7vw] mt-[-0.987vw] max-w-fit text-[9vw] font-normal text-black transition-colors duration-200 hover:text-[#FAE00D] ipadair:mb-[-4.934vw] ipadair:text-[6.316vw]"
              style={{ fontFamily: "Ahsing" }}
            >
              2
            </p>
            <p
              className="mb-[-7vw] me-[0.329vw] mt-[-0.987vw] max-w-fit self-end text-[9vw] font-normal text-black transition-colors duration-200 hover:text-[#FAE00D] ipadair:mb-[-4.934vw] ipadair:text-[6.316vw]"
              style={{ fontFamily: "Ahsing" }}
            >
              5
            </p>
        ...
        <div className="relative ms-[1.842vw] hidden h-[15.115vw] w-[15.115vw] ipadair:bottom-[6vw] ipadair:block ipadair:h-[6.526vw] ipadair:w-[6.526vw]">
          <Image
            src="/assets/landing/spark.gif"
            alt="Spark"
            layout="responsive"
      ...
      <div className="relative left-[2.945vw] top-[-3.658vw] h-[90.065vw] ipadair:h-[31.026vw]">
        {/* Card 1 */}
        <div
          className={
            "absolute right-[20.171vw] top-[43.237vw] z-[32] ipadair:z-[32] h-[18.333vw] w-[14.444vw] rounded-[2.053vw] border border-black bg-[#00E9F4] shadow-black ipadair:right-[37.171vw] ipadair:top-[-7.237vw] ipadair:h-[13.092vw] ipadair:w-[8.0vw] ipadair:rounded-[1.053vw] " +
            styles.cardOne
          }
        >
          <div className="flex h-[3.75vw] w-full flex-row items-center gap-[0.755vw] rounded-t-[2.053vw] border-b-[0.132vw] border-t-[0px] border-black bg-white px-[1.526vw] ipadair:h-[2.368vw] ipadair:gap-[0.526vw] ipadair:rounded-t-[1.053vw] ipadair:border-t-[0.132vw] ipadair:px-[0.526vw]">
            <div className="h-[1.512vw] w-[1.512vw] rounded-full bg-black ipadair:h-[1.053vw] ipadair:w-[1.053vw]"></div>
            <div className="h-[1.512vw] w-[1.512vw] rounded-full bg-black ipadair:h-[1.053vw] ipadair:w-[1.053vw]"></div>
            <div className="h-[1.512vw] w-[1.512vw] rounded-full bg-black ipadair:h-[1.053vw] ipadair:w-[1.053vw]"></div>
          </div>
          <div className="flex h-[80%] items-center justify-center">
            <div className="h-[9.692vw] w-[9.692vw] ipadair:h-[5.592vw] ipadair:w-[5.592vw]">
              <Image
        ...
        <div
          className={
            "absolute overflow-x-hidden right-[10.724vw] top-[8.974vw] z-[31] h-[37.778vw] w-[37.778vw] rounded-[2.053vw] border border-black bg-[#008EFF] shadow-black ipadair:right-[20.724vw] ipadair:top-[1.974vw] ipadair:z-[31] ipadair:h-[18.75vw] ipadair:w-[18.75vw] ipadair:rounded-[1.053vw] " +
            styles.cardOne
          }
        >
          <div className="flex h-[3.75vw] w-full flex-row items-center gap-[0.755vw] rounded-t-[2.053vw] border-b-[0.132vw] border-t-[0px] border-black bg-white px-[1.526vw] ipadair:h-[2.368vw] ipadair:gap-[0.526vw] ipadair:rounded-t-[1.053vw] ipadair:border-t-[0.132vw] ipadair:px-[0.526vw]">
          ...
          <div className="flex h-[80%] flex-col justify-end">
            <div className="relative flex flex-col justify-center w-full">
              <div className={"flex flex-col items-center justify-center w-fit ipadair:px-[1vw] px-[2vw] gap-[1.833vw] ipadair:gap-[0.833vw] "+ styles.cardTwoSpark1}>
              <div className="h-[7.167vw] w-[7.167vw] ipadair:h-[4.368vw] ipadair:w-[4.368vw]">
                <Image
                  src="/assets/landing/spark.gif"
                  alt="spark"
                  layout="responsive"
              ...
              <div className="relative h-[5.167vw] w-[5.167vw] ipadair:h-[2.368vw] ipadair:w-[2.368vw]">
                <Image
                  src="/assets/landing/spark.gif"
                  alt="spark"
                  layout="responsive"
            ...
            <div className="mx-[1.053vw] flex w-full gap-[1.512vw] ipadair:gap-[1.053vw]">
              <p
                className="text-[6.358vw] font-normal leading-[6.358vw] tracking-wide text-black ipadair:text-[3.158vw] ipadair:leading-[3.158vw]"
                style={{ fontFamily: "Ahsing" }}
              >
                Lucid Labyrinth
              </p>
          ...
          {/* <p
            className={
              "absolute left-[2.368vw] top-[-9.211vw] w-[11.576vw] text-[17.197vw] font-normal leading-[15.261vw] tracking-wide text-white ipadair:left-[3.368vw] ipadair:top-[-10.211vw] ipadair:w-[8.061vw] ipadair:text-[9.197vw] " +
              styles.cText
            }
        ...
        <div
          className={
            "absolute right-[1.855vw] top-[-19.184vw] z-30 h-[33.889vw] w-[41.667vw]  rounded-[2.053vw] border border-black bg-[#00FF88] shadow-black ipadair:right-[10.855vw] ipadair:top-[-11.184vw] ipadair:h-[18.75vw] ipadair:w-[23.026vw] ipadair:rounded-[1.053vw] " +
            styles.cardOne
          }
        >
          <div className="flex h-[3.75vw] w-full flex-row items-center gap-[0.755vw] rounded-t-[2.053vw] border-b-[0.132vw] border-t-[0px] border-black bg-white px-[1.526vw] ipadair:h-[2.368vw] ipadair:gap-[0.526vw] ipadair:rounded-t-[1.053vw] ipadair:border-t-[0.132vw] ipadair:px-[0.526vw]">
          ...
          <div className="relative h-[85%] w-full p-2">
            <div
              className={
                "absolute w-[16.389vw] ipadair:w-[9.013vw] " +
          ...
          {/* <p
            className={
              "absolute bottom-[-0.592vw] left-[-3.158vw] w-[11.576vw] text-[17.197vw] font-normal leading-[15.261vw] tracking-wide text-[#B572F9] ipadair:top-[-1.392vw] ipadair:left-[-0.158vw] ipadair:w-[8.061vw] ipadair:text-[9.197vw] " +
              styles.cText
            }
            onMouseEnter={() => setIsCHovered(true)}
            onMouseLeave={() => setIsCHovered(false)}
          ...
          {/* <p
            className={
              "absolute bottom-[-0.947vw] right-[0.87vw] w-[11.576vw] text-[15.5vw] font-normal tracking-wide text-[#B572F9] ipadair:top-[-5.947vw] ipadair:right-[-1.87vw] ipadair:w-[8.061vw] ipadair:text-[8.197vw] " +
              styles.nText
            }
        ...
        <div
          className={
            "group absolute right-[-17.618vw] top-[-4.658vw]  z-30 h-[41.389vw] w-[24.167vw] overflow-hidden rounded-[2.053vw] border border-black bg-[#E1067B] shadow-[0.526vw_0.526vw_0px_#000000] shadow-black transition duration-300 hover:bg-black hover:shadow-[#E1067B] ipadair:right-[3.618vw] ipadair:top-[-2.658vw] ipadair:z-[30] ipadair:h-[19.737vw] ipadair:w-[11.513vw] ipadair:rounded-[1.053vw] " +
        ...
        >
          ...
          <div className="relative h-[80%] w-full flex-col">
            <svg
              className={
                "absolute bottom-0 right-[0.263vw] h-[8.975vw] w-[8.975vw] text-black transition-all duration-300 group-hover:text-white ipadair:h-[6.25vw] ipadair:w-[6.25vw] " +
                styles.svgContainer
              }
              viewBox="0 0 120 120"
              fill="currentColor"
          ...
          <div className="absolute left-[-3.005vw] top-[-1.974vw] flex gap-[2.937vw] overflow-visible ipadair:gap-[2.045vw]">
            {/* <p
              className={
                "relative w-[10.858vw] text-[8.197vw] font-normal tracking-wide text-white ipadair:w-[7.561vw] " +
                styles.nText
              }
              onMouseEnter={() => setIsMHovered(true)}
              onMouseLeave={() => setIsMHovered(false)}
            ...
            {/* <p
              className={
                "relative left-[-1vw] top-[10.316vw] h-[23.618vw] w-fit text-[15.197vw] font-normal leading-[8.197vw] tracking-wide text-white hover:text-[11.197vw] ipadair:left-[-0.5vw] ipadair:top-[-1.316vw] ipadair:h-[16.447vw] ipadair:text-[8.197vw] ipadair:hover:text-[7.197vw] " +
                styles.gText
              }
            >
              I
        ...
        <div
          className={
            "group z-30 absolute left-[9.921vw] top-[3.566vw] w-[28.056vw] overflow-hidden rounded-[2.053vw] border border-black bg-[#00FF88] shadow-[0.526vw_0.526vw_0px_#000000] shadow-black transition duration-300 hover:bg-black ipadair:left-[-5.921vw] ipadair:top-[1.566vw] ipadair:w-[14.474vw] ipadair:rounded-[1.053vw]"
          }
        >
          ...
          {/* <div className="flex h-[3.75vw] w-full flex-row items-center gap-[0.755vw] rounded-t-[2.053vw] border-b-[0.132vw] border-t-[0px] border-black bg-white px-[1.526vw] transition-all duration-300 group-hover:border-white group-hover:bg-black ipadair:h-[2.368vw] ipadair:gap-[0.526vw] ipadair:rounded-t-[1.053vw] ipadair:border-t-[0.132vw] ipadair:px-[0.526vw]">
            <div className="h-[1.512vw] w-[1.512vw] rounded-full bg-black transition-[bg] duration-300 group-hover:bg-white ipadair:h-[1.053vw] ipadair:w-[1.053vw]"></div>
            <div className="h-[1.512vw] w-[1.512vw] rounded-full bg-black transition-[bg] duration-300 group-hover:bg-white ipadair:h-[1.053vw] ipadair:w-[1.053vw]"></div>
            <div className="h-[1.512vw] w-[1.512vw] rounded-full bg-black transition-[bg] duration-300 group-hover:bg-white ipadair:h-[1.053vw] ipadair:w-[1.053vw]"></div>
          </div> */}
          <div className="flex h-full flex-col justify-end">
            <div className="absolute top-[9vw] flex w-full overflow-visible ipadair:top-[-1vw]">
              {/* <p
                className={
                  "relative left-[2.587vw] top-[-5.316vw] w-[10.858vw] text-[15.5vw] font-normal leading-[none] tracking-wide text-white hover:text-[11.197vw] group-hover:text-[#00FF88] ipadair:left-[1.587vw] ipadair:top-[1.316vw] ipadair:w-[7.561vw] ipadair:text-[9.197vw] ipadair:hover:text-[7.197vw] " +
                  styles.nText
                }
              >
                N
              ...
              <p
                className={
                  "relative left-[4vw] top-[3.947vw] h-[23.618vw] w-[11.576vw] text-[13.197vw] font-normal leading-[none] tracking-wide text-white hover:text-[11.197vw] group-hover:text-[#00FF88] ipadair:left-[1vw] ipadair:h-[16.447vw] ipadair:w-[8.061vw] ipadair:text-[8.197vw] ipadair:hover:text-[7.197vw] " +
                  styles.gText
                }
              >
                G
        ...
        <div
          className={
            "absolute left-[-45.316vw] top-[58.158vw] z-[2] h-[23.611vw] w-[43.889vw] overflow-hidden rounded-[2.053vw] border border-black bg-[#B5FCFF] shadow-black ipadair:left-[-1.316vw] ipadair:top-[14.158vw] ipadair:z-[0] ipadair:h-[11.842vw] ipadair:w-[22.039vw] ipadair:rounded-[1.053vw] " +
            styles.cardOne
          }
        >
          <div className="flex h-[3.75vw] w-full flex-row items-center gap-[0.755vw] rounded-t-[2.053vw] border-b-[0.132vw] border-t-[0px] border-black bg-white px-[1.526vw] ipadair:h-[2.368vw] ipadair:gap-[0.526vw] ipadair:rounded-t-[1.053vw] ipadair:border-t-[0.132vw] ipadair:px-[0.526vw]">
          ...
          <div className="flex h-[80%] w-full items-end justify-center gap-[1.133vw] px-1 py-3 ipadair:gap-[0.789vw]">
            <div
              className={
                "h-[10.556vw] w-[10.556vw] ipadair:h-[5.263vw] ipadair:w-[5.263vw] " +
        ...
        <div
          className={
            "absolute left-[-14.763vw] top-[42.574vw] h-[33.611vw] w-[52.778vw] rounded-[2.053vw] border border-black bg-[#FAE00D] shadow-black ipadair:left-[7.237vw] ipadair:top-[-2.574vw] ipadair:h-[18.75vw] ipadair:w-[29.276vw] ipadair:rounded-[1.053vw] " +
            styles.cardOne
          }
        >
          <div className="relative z-[2] flex h-[3.75vw] w-full flex-row items-center gap-[0.755vw] rounded-t-[2.053vw] border-b-[0.132vw] border-t-[0px] border-black bg-white px-[1.526vw] ipadair:h-[2.368vw] ipadair:gap-[0.526vw] ipadair:rounded-t-[1.053vw] ipadair:border-t-[0.132vw] ipadair:px-[0.526vw]">
            <div className="h-[1.512vw] w-[1.512vw] rounded-full bg-black ipadair:h-[1.053vw] ipadair:w-[1.053vw]"></div>
            <div className="h-[1.512vw] w-[1.512vw] rounded-full bg-black ipadair:h-[1.053vw] ipadair:w-[1.053vw]"></div>
            <div className="h-[1.512vw] w-[1.512vw] rounded-full bg-black ipadair:h-[1.053vw] ipadair:w-[1.053vw]"></div>
          </div>
          <div className="relative h-[85%] w-full">
            <svg
              className="absolute left-[17.882vw] top-[5.882vw] w-[20.118vw] ipadair:left-[14.882vw] ipadair:top-[-0.5vw] ipadair:w-[11.118vw]"
              viewBox="0 0 102 109"
              fill="none"
              xmlns="http://www.w3.org/2000/svg"
            >
            ...
            <p
              className="absolute bottom-[18.625vw] left-[6.316vw] z-30 text-[6.389vw] font-normal tracking-wide text-black ipadair:bottom-0 ipadair:left-[-1.316vw] ipadair:text-[4.211vw]"
              style={{ fontFamily: "Ahsing" }}
            >
              Cultural Fest
            </p>
          </div>
          <div className="absolute left-[5.645vw] top-0 flex h-[85%] w-full overflow-hidden ipadair:left-[1.645vw]">
            {/* <p
              className={
                "relative left-[0] top-[-16.961vw] z-[2] w-[10.858vw] text-[18.197vw] font-normal leading-[38vw] tracking-wide text-white hover:top-[-13vw] hover:text-[14.197vw] ipadair:left-[1vw] ipadair:top-[-8.961vw] ipadair:w-[7.561vw] ipadair:text-[10.197vw] ipadair:leading-[21vw] ipadair:hover:top-[-6.961vw] ipadair:hover:text-[7.197vw] " +
            ...
            <p
              className={
                "relative top-[-16.961vw] z-[1] w-[13.858vw] text-[18.197vw] font-normal leading-[38vw] tracking-wide text-white hover:top-[-13vw] hover:text-[14.197vw] ipadair:top-[-8.961vw] ipadair:w-[7.561vw] ipadair:text-[10.197vw] ipadair:leading-[21.197vw] ipadair:hover:top-[-7.961vw] ipadair:hover:text-[7.197vw] " +
                styles.comingSoonBorders
              }
            >
              O
            ...
            <p
              className={
                "relative top-[-16.961vw] z-[2] w-[13.858vw] text-[18.197vw] font-normal leading-[38vw] tracking-wide text-white hover:top-[-13vw] hover:text-[14.197vw] ipadair:top-[-8.961vw] ipadair:w-[7.561vw] ipadair:text-[10.197vw] ipadair:leading-[21.197vw] ipadair:hover:top-[-6.961vw] ipadair:hover:text-[7.197vw] " +
                styles.comingSoonBorders
              }
            >
              O
        ...
        <div
          className={
            "z-1 group absolute left-[26.553vw] top-[63.224vw] h-[22.778vw] w-[13.889vw] overflow-hidden rounded-[2.053vw] border border-black bg-[#00E9F4] shadow-[0.329vw_0.329vw_0px_#000000] shadow-black transition duration-300 hover:bg-black hover:shadow-[#00E9F4] ipadair:left-[33.553vw] ipadair:top-[8.224vw] ipadair:h-[12.171vw] ipadair:w-[7.237vw] ipadair:rounded-[1.053vw] " +
            styles.card8Container
          }
        >
          <div className="flex h-[3.75vw] w-full flex-row items-center gap-[0.755vw] rounded-t-[2.053vw] border-b-[0.132vw] border-t-[0px] border-black bg-white px-[1.526vw] transition-all duration-300 group-hover:border-white group-hover:bg-black ipadair:h-[2.368vw] ipadair:gap-[0.526vw] ipadair:rounded-t-[1.053vw] ipadair:border-t-[0.132vw] ipadair:px-[0.526vw]">
            <div className="h-[1.512vw] w-[1.512vw] rounded-full bg-black transition-all duration-300 group-hover:bg-white ipadair:h-[1.053vw] ipadair:w-[1.053vw]"></div>
            <div className="h-[1.512vw] w-[1.512vw] rounded-full bg-black transition-all duration-300 group-hover:bg-white ipadair:h-[1.053vw] ipadair:w-[1.053vw]"></div>
            <div className="h-[1.512vw] w-[1.512vw] rounded-full bg-black transition-all duration-300 group-hover:bg-white ipadair:h-[1.053vw] ipadair:w-[1.053vw]"></div>
          </div>
          <div className="relative flex h-[78%] w-full justify-center">
            <svg
              className={
                "absolute bottom-0 w-[9.07vw] text-black transition-all duration-300 group-hover:text-[#00E9F4] ipadair:w-[6.316vw] " +
                styles.svgIcon
              }
              viewBox="0 0 120 148"
              fill="currentColor"
        ...
        {/* <p
          className={
            "absolute left-[30.508vw] top-[33.579vw] z-[2] w-[10.858vw] text-[18.197vw] font-normal leading-[21vw] tracking-wide text-[#B572F9] hover:top-[-12vw] hover:text-[14.197vw] ipadair:left-[-47.508vw] ipadair:top-[-18vw] ipadair:w-[7.561vw] ipadair:text-[10.197vw] ipadair:leading-[10vw] ipadair:hover:top-[-6vw] ipadair:hover:text-[7.197vw] " +
            styles.comingSoonBorders
          }
        >
          I
        ...
        <p
          className={
            "absolute right-[17.724vw] top-[2.974vw] z-30 w-fit text-[17.197vw] font-normal leading-[10vw] tracking-wide text-[#B572F9] hover:top-[0.974vw] hover:text-[12.197vw] ipadair:right-[19.724vw] ipadair:top-[-15.974vw] ipadair:w-[7.561vw] ipadair:text-[12.197vw] ipadair:leading-[10vw] ipadair:hover:text-[8.197vw] " +
            styles.comingSoonBorders
          }
        >
          A
        ...
        {/* Svg1 */}
        <svg
          className="absolute left-[4vw] top-[-29vw] z-[1000] w-[8.188vw] ipadair:left-[-9vw] ipadair:top-[-12vw] ipadair:w-[3.188vw]"
          viewBox="0 0 57 57"
          fill="none"
          xmlns="http://www.w3.org/2000/svg"
        >
        ...
        {/* Svg2 */}
        <svg
          className="absolute left-[19vw] top-[-22vw] z-[1000] w-[4.188vw] ipadair:left-[2vw] ipadair:top-[-14vw] ipadair:w-[2.188vw]"
          width="37"
          height="33"
          viewBox="0 0 37 33"
          fill="none"
        ...
        {/* Svg3 */}
        <svg
          className="absolute z-[1000] hidden ipadair:left-[22vw] ipadair:top-[-16vw] ipadair:block ipadair:w-[0.5vw]"
          viewBox="0 0 11 11"
          fill="none"
          xmlns="http://www.w3.org/2000/svg"
        >
        ...
        {/* Svg4 */}
        <svg
          className="absolute left-[21vw] top-[31vw] z-[1000] w-[3.5vw] ipadair:left-[-31vw] ipadair:top-[-13vw] ipadair:w-[0.5vw]"
          viewBox="0 0 32 32"
          fill="none"
          xmlns="http://www.w3.org/2000/svg"
        >
        ...
        {/* Svg5 */}
        <svg
          className="absolute z-[1000] hidden ipadair:left-[-24vw] ipadair:top-[-16vw] ipadair:block ipadair:w-[3.5vw]"
          viewBox="0 0 61 58"
          fill="none"
          xmlns="http://www.w3.org/2000/svg"
        >
        ...
        {/* Svg6 */}
        <svg
          className="absolute left-[34vw] top-[20vw] z-[1000] w-[7.5vw] ipadair:left-[35vw] ipadair:top-[-16vw] ipadair:w-[2.5vw]"
          viewBox="0 0 50 50"
          fill="none"
          xmlns="http://www.w3.org/2000/svg"
        >
        ...
        {/* Svg7 */}
        <svg
          className="absolute hidden ipadair:left-[32vw] ipadair:top-[-9vw] ipadair:block ipadair:w-[2.5vw]"
          viewBox="0 0 36 36"
          fill="none"
          xmlns="http://www.w3.org/2000/svg"
        >
        ...
        {/* Svg8 */}
        <svg
          className="absolute hidden ipadair:left-[38vw] ipadair:top-[7vw] ipadair:block ipadair:w-[4.844vw]"
          viewBox="0 0 101 61"
          fill="none"
          xmlns="http://www.w3.org/2000/svg"
        >
        ...
        {/* Svg8*/}
        <svg
          className="absolute hidden ipadair:left-[29vw] ipadair:top-[21vw] ipadair:block ipadair:w-[1.5vw]"
          viewBox="0 0 28 27"
          fill="none"
          xmlns="http://www.w3.org/2000/svg"
        >
        ...
        {/* Svg9*/}
        <svg
          className="absolute left-[34vw] top-[88vw] z-[1000] w-[7.5vw] ipadair:left-[23vw] ipadair:top-[18vw] ipadair:w-[4.5vw]"
          viewBox="0 0 72 29"
          fill="none"
          xmlns="http://www.w3.org/2000/svg"
        >
        ...
        {/* Svg10*/}
        <svg
          className="absolute left-[24vw] top-[82vw] z-[1000] w-[7.5vw] ipadair:left-[-6vw] ipadair:top-[19vw] ipadair:w-[4.5vw]"
          viewBox="0 0 84 84"
          fill="none"
          xmlns="http://www.w3.org/2000/svg"
        >
        ...
        {/* Svg11*/}
        <svg
          className="absolute left-[-30vw] top-[86vw] z-[1000] w-[5.5vw] ipadair:left-[-11vw] ipadair:top-[22vw] ipadair:w-[2.5vw]"
          viewBox="0 0 46 38"
          fill="none"
          xmlns="http://www.w3.org/2000/svg"
        >
        ...
        {/* Svg12*/}
        <svg
          className="absolute left-[-18vw] top-[51vw] z-[1000] w-[7.5vw] ipadair:left-[-19vw] ipadair:top-[20vw] ipadair:w-[3.5vw]"
          viewBox="0 0 65 65"
          fill="none"
          xmlns="http://www.w3.org/2000/svg"
        >
        ...
        {/* Svg13*/}
        <svg
          className="absolute left-[-14vw] top-[30vw] z-[1000] w-[5.5vw] ipadair:left-[-22vw] ipadair:top-[13vw] ipadair:w-[3.5vw]"
          viewBox="0 0 63 50"
          fill="none"
          xmlns="http://www.w3.org/2000/svg"
        >
        ...
        {/* Svg14*/}
        <svg
          className="absolute left-[-17vw] top-[-23vw] z-[1000] w-[12.5vw] ipadair:left-[-14vw] ipadair:top-[-9vw] ipadair:w-[7.5vw]"
          viewBox="0 0 160 160"
          fill="none"
          xmlns="http://www.w3.org/2000/svg"
        >
        ...
        <svg className="absolute left-[-50vw] top-[-5vw] z-[1000] w-[6.5vw] ipadair:left-[-46vw] ipadair:top-[4.8vw] ipadair:w-[3vw]" viewBox="0 0 69 69" fill="none" xmlns="http://www.w3.org/2000/svg">
...
<feBlend mode="normal" in="SourceGraphic" in2="effect1_dropShadow_3244_3509" result="shape"/>
        ...
        {/* Svg16*/}
        <svg
          className="absolute left-[-49vw] top-[6vw] z-[1000] w-[1.5vw] ipadair:left-[-46vw] ipadair:top-[-9vw] ipadair:w-[1vw]"
          viewBox="0 0 20 20"
          fill="none"
          xmlns="http://www.w3.org/2000/svg"
        >
        ...
        {/* Svg17*/}
        <svg
          className="absolute left-[-48vw] top-[-22vw] z-[1000] w-[4.5vw] ipadair:left-[-51vw] ipadair:top-[-15vw] ipadair:w-[3vw]"
          viewBox="0 0 50 46"
          fill="none"
          xmlns="http://www.w3.org/2000/svg"
        >
        ...
        {/* Svg18*/}
        <svg
          className="absolute left-[-51vw] top-[18vw] z-[1000] w-[5.5vw] ipadair:left-[-49vw] ipadair:top-[-5vw] ipadair:w-[4vw]"
          viewBox="0 0 64 64"
          fill="none"
          xmlns="http://www.w3.org/2000/svg"
        >
        ...
        {/* Svg19*/}
        <svg
          className="absolute left-[-46vw] top-[52vw] z-[1000] w-[5.5vw] ipadair:left-[-45vw] ipadair:top-[10vw] ipadair:w-[4vw]"
          viewBox="0 0 57 57"
          fill="none"
          xmlns="http://www.w3.org/2000/svg"
        >
        ...
        {/* Svg20*/}
        <svg
          className="absolute left-[-43vw] top-[85vw] z-[1000] w-[1.5vw] ipadair:left-[-41vw] ipadair:top-[23vw] ipadair:w-[0.5vw]"
          viewBox="0 0 11 11"
          fill="none"
          xmlns="http://www.w3.org/2000/svg"
        >
        ...
        {/* Svg21*/}
        <svg
          className="absolute left-[-4vw] top-[79vw] z-[1000] w-[4.5vw] ipadair:left-[-30vw] ipadair:top-[20vw] ipadair:w-[2.5vw]"
          viewBox="0 0 50 50"
          fill="none"
          xmlns="http://www.w3.org/2000/svg"
        >
      ...
      <div className="absolute ipadair:top-[0] top-[18vw] flex ipadair:flex-row flex-col items-centre justify-center gap-[0.5vw] z-[1000]">
        <div className="relative left-[-8vw] ipadair:left-0 flex ipadair:gap-[0.5vw] gap-[1vw]"> 
        <svg className="absolute ipadair:w-[20vw] w-[30vw] ipadair:top-[2vw] top-[-15vw] ipadair:left-[-4vw] left-[-1vw] overflow-visible" viewBox="0 0 386 367" fill="none" xmlns="http://www.w3.org/2000/svg">
...
<g>
  ...
  <animateMotion repeatCount="indefinite" dur="8s">
    <mpath href="#mainPath"/>
        ...
        <p
          className={
            "ipadair:text-[11vw] text-[22vw] text-[#B572F9] ipadair:w-[3vw] ipadair:h-[13vw] w-[6vw] h-[24vw] " +
            styles.comingSoonBorders
          }
        >
          I
        ...
        <p
          className={
            "relative ipadair:text-[11vw] text-[23vw] left-[1vw] ipadair:top-[2vw] top-[3vw] text-[#B572F9] ipadair:h-[14vw] ipadair:w-[7vw] h-[26vw] w-[14vw] " +
            styles.comingSoonBorders
          }
        >
          N
        ...
        <p
          className={
            "relative left-[1vw] ipadair:top-[6vw] top-[12vw] ipadair:text-[9vw] text-[16vw] text-[#B572F9] ipadair:h-[11vw] ipadair:w-[7vw] h-[20vw] w-[12vw] " +
            styles.comingSoonBorders
          }
        >
          C
        ...
        <p
          className={
            "relative ipadair:text-[13vw] text-[24vw] left-[0.5vw] top-[-2.5vw] text-[#B572F9] ipadair:h-[16vw] ipadair:w-[10vw] h-[30vw] w-[18vw] " +
            styles.comingSoonBorders
          }
        >
          A
        ...
        <p
          className={
            "relative ipadair:text-[9vw] text-[18vw] ipadair:top-[-1vw] top-[3vw] text-[#B572F9] ipadair:h-[12vw] ipadair:w-[6vw] h-[22vw] w-[10vw] " +
            styles.comingSoonBorders
          }
        >
          N
        ...
        <p
          className={
            "relative top-[2vw] ipadair:text-[11vw] text-[21vw] text-[#B572F9] ipadair:h-[14vw] ipadair:w-[6.5vw] h-[26vw] w-[14vw] " +
            styles.comingSoonBorders
          }
        >
          D
        ...
        <div className="relative ipadair:left-0 ipadair:top-0 left-[7vw] top-[-2vw] flex ipadair:gap-[0.5vw] gap-[3vw]">
        <p
          className={
            "relative ipadair:text-[10vw] text-[16vw] ipadair:top-[-1vw] top-[5vw] text-[#B572F9] ipadair:w-[6vw] w-[7vw] h-[13vw] " +
            styles.comingSoonBorders
          }
        >
          E
        ...
        <p
          className={
            "relative ipadair:text-[13vw] text-[24vw] top-[2vw] text-[#B572F9] ipadair:w-[8vw] w-[10vw] h-[16vw] " +
            styles.comingSoonBorders
          }
        >
          S
        ...
        <p
          className={
            "relative ipadair:top-[2vw] top-[5vw] ipadair:text-[9vw] text-[15vw] text-[#B572F9] ipadair:w-[6vw] w-[7vw] h-[11vw] " +
            styles.comingSoonBorders
          }
        >
          C
        ...
        <p
          className={
            "relative ipadair:text-[9vw] text-[16vw] ipadair:top-0 top-[6vw]  text-[#B572F9] h-[11vw] ipadair:w-[6vw] w-[7vw] " +
            styles.comingSoonBorders
          }
        >
          E
        ...
        <p
          className={
            "ipadair:text-[13vw] text-[22vw] text-[#B572F9] h-[16vw] ipadair:w-[7vw] w-[10vw] " +
            styles.comingSoonBorders
          }
        >
          N
        ...
        <p
          className={
            "relative top-[8vw] ipadair:text-[9vw] text-[15vw] text-[#B572F9] h-[11vw] ipadair:w-[5.5vw] w-[8vw] " +
            styles.comingSoonBorders
          }
        >
          C
        ...
        <p
          className={
            "ipadair:text-[13vw] text-[23vw] text-[#B572F9] h-[16vw] w-[8vw] " +
            styles.comingSoonBorders
          }
        >
          E
    ...
    <div className="absolute ipadair:bottom-[1vw] ipadair:left-[2vw] bottom-[2vw] left-[4vw] flex"  style={{ transform: `scale(${scale})`, transformOrigin: "0 100%" }}>
      <p className="ipadair:text-[2vw] text-[6vw]" style={{fontFamily: "Tusker Grotesk"}}>Scroll Down</p>
      <div className="relative ipadair:w-[1.5vw] w-[3vw] ipadair:left-[1vw] left-[2vw]">
      <Image
